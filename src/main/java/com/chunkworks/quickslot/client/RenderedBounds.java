...
final class RenderedBounds implements VertexConsumer {
    record Shape(Bounds bounds, boolean sprite) {}
    ...
    static Shape measure(AbstractClientPlayer player, ItemStack stack, int light) {
        ...
        try {
            ...
            return new Shape(bounds, bounds.squareSprite() && !vertices.rotatedFaces);
            ...
            return new Shape(new Bounds(-0.5, -0.5, -0.5, 0.5, 0.5, 0.5), false);
        }
    }
    private VertexConsumer consumer() {
        ...
        return new VertexConsumer() {
            @Override public VertexConsumer addVertex(float x, float y, float z) { RenderedBounds.this.addVertex(x, y, z); return this; }
